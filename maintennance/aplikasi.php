...
<?php if (empty($data_prestasi)) : ?>
			<table align="center" cellpadding="0" cellspacing="0" width="100%" border="1">
                <tr>
					...
					<th width="10%">Terakhir di edit</th>
			...
			<table align="center" cellpadding="0" cellspacing="0" width="100%" border="1">
                ...
                <tr>
                    ...
                    <td rowspan = "2" align = "center">
                        <a href="edit-prestasi.php?aaa=<?php echo $prestasi['ID']; ?>"> <button class="btn btn-edit">Checklist</button></a>
                        <a href="delete-prestasi.php?aaa=<?php echo $prestasi['ID']; ?>"> <button class="btn btn-hapus">Hapus</button></a>
					</td>
                </tr>
				<tr>
